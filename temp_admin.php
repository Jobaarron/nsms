...
public function updateEnrollment(Request $request, $id)
{
 ...
        / * * 
        / * * 
           *   S h o w   f o r w a r d e d   c a s e   m e e t i n g s   f o r   a d m i n   ( p r e s i d e n t ) 
           * / 
         p u b l i c   f u n c t i o n   f o r w a r d e d C a s e s ( ) 
         { 
                 i f   ( $ r e s p o n s e   =   $ t h i s - > c h e c k A d m i n A u t h ( ) )   { 
                         r e t u r n   $ r e s p o n s e ; 
                 } 
 
                 $ c a s e M e e t i n g s   =   \ A p p \ M o d e l s \ C a s e M e e t i n g : : w i t h ( [  
 s t u d e n t ,   c o u n s e l o r ,   s a n c t i o n s ] ) 
                         - > w h e r e ( s t a t u s ,   f o r w a r d e d ) 
                         - > w h e r e ( f o r w a r d e d _ t o _ p r e s i d e n t ,   t r u e ) 
                         - > o r d e r B y ( f o r w a r d e d _ a t ,   d e s c ) 
                         - > p a g i n a t e ( 2 0 ) ; 
 
                 r e t u r n   v i e w ( a d m i n . f o r w a r d e d - c a s e s ,   c o m p a c t ( c a s e M e e t i n g s ) ) ; 
         } 
 
         / * * 
           *   A p p r o v e   a   s a n c t i o n   a n d   m a r k   c a s e   m e e t i n g   a s   c o m p l e t e d 
           * / 
         p u b l i c   f u n c t i o n   a p p r o v e S a n c t i o n ( \ I l l u m i n a t e \ H t t p \ R e q u e s t   $ r e q u e s t ,   \ A p p \ M o d e l s \ S a n c t i o n   $ s a n c t i o n ) 
         { 
                 i f   ( $ r e s p o n s e   =   $ t h i s - > c h e c k A d m i n A u t h ( ) )   { 
                         r e t u r n   $ r e s p o n s e ; 
                 } 
 
                 i f   ( $ s a n c t i o n - > i s _ a p p r o v e d )   { 
                         r e t u r n   r e s p o n s e ( ) - > j s o n ( [ 
                                 s u c c e s s   = >   f a l s e , 
                                 m e s s a g e   = >   S a n c t i o n  
 i s  
 a l r e a d y  
 a p p r o v e d . 
                         ] ,   4 0 0 ) ; 
                 } 
 
                 $ s a n c t i o n - > u p d a t e ( [ 
                         i s _ a p p r o v e d   = >   t r u e , 
                         a p p r o v e d _ b y   = >   a u t h ( ) - > i d ( ) , 
                         a p p r o v e d _ a t   = >   n o w ( ) , 
                 ] ) ; 
 
                 / /   M a r k   r e l a t e d   c a s e   m e e t i n g   a s   c o m p l e t e d 
                 $ c a s e M e e t i n g   =   $ s a n c t i o n - > c a s e M e e t i n g ; 
                 i f   ( $ c a s e M e e t i n g   & &   $ c a s e M e e t i n g - > s t a t u s   ! = =   c o m p l e t e d )   { 
                         $ c a s e M e e t i n g - > u p d a t e ( [ 
                                 s t a t u s   = >   c o m p l e t e d , 
                                 c o m p l e t e d _ a t   = >   n o w ( ) , 
                         ] ) ; 
                 } 
 
                 r e t u r n   r e s p o n s e ( ) - > j s o n ( [ 
