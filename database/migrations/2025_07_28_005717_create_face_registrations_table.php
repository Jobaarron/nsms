...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('face_registrations', function (Blueprint $table) {
            ...
            $table->longText('face_encoding'); // Store the face encoding/embedding as JSON
            ...
            $table->float('confidence_score')->default(0.0); // Confidence score of the face encoding
            $table->json('face_landmarks')->nullable(); // Store face landmarks as JSON
            $table->enum('source', ['id_photo', 'manual_upload', 'camera_capture'])->default('id_photo'); // Source of face data
