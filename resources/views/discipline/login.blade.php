        ...
        <div class="col-lg-6 col-md-8">
            <div class="content-card p-5">
                <div class="text-center mb-4">
                    ...
                    <h2 class="page-header mb-2">Discipline Portal Login</h2>
                    <p class="text-muted">Login to access the discipline management system</p>
                </div>
                ...
                <form method="POST" action="{{ route('discipline.login.submit') }}">
                    @csrf
                ...
                {{-- <div class="text-center">
                    <small class="text-muted">
                        ...
                        For discipline staff only - Contact administrator for assistance
                    </small>
                </div> --}}
            </div>
        </div>
