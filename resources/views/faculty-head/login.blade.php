        ...
        <div class="col-lg-6 col-md-8">
            <div class="content-card p-5">
                <div class="text-center mb-4">
                    <i class="ri-user-star-line" style="font-size: 4rem; color: var(--primary-color);"></i>
                    <h2 class="page-header mb-2">Faculty Head Login</h2>
                    <p class="text-muted">Login to access your faculty head dashboard</p>
                </div>
                ...
                <form method="POST" action="{{ route('faculty-head.login.submit') }}">
                    @csrf
