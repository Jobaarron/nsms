<x-cashier-layout>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="section-title mb-1">Due Payments</h2>
                    <p class="text-muted mb-0">Payments that require immediate attention</p>
                </div>
                <div class="text-end">
                    <span class="badge bg-danger fs-6">{{ $payments->total() }} Due</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 pb-0">
                    <h5 class="card-title mb-0">
                        <i class="ri-alarm-warning-line me-2 text-danger"></i>Overdue & Due Payments
                    </h5>
                </div>
                <div class="card-body">
                    @if($payments->count() > 0)
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-muted">No Due Payments</h5>
    ...
    <!-- Include the same modals from pending-payments -->
