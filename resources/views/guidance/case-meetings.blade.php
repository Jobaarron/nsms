                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                @endif
                                                @if(in_array($meeting->status, ['scheduled', 'completed']) && !$meeting->summary)
                                                    <button class="btn btn-outline-info" onclick="openCreateSummaryModal({{ $meeting->id }})" title="Add Summary">
