        ...
        <div class="col-lg-6 col-md-8">
            <div class="content-card p-5">
                <div class="text-center mb-4">
                    ...
                    <h2 class="page-header mb-2">Guidance & Discipline Login</h2>
                    <p class="text-muted">Login to access the guidance and discipline system</p>
                </div>
                ...
                <form method="POST" action="{{ route('guidance.login.submit') }}">
                    @csrf
                ...
                <div class="text-center mt-4">
                    <small class="text-muted">
                        ...
                        For guidance counselors, discipline officers, and security guards only
                    </small>
                </div>
