<x-registrar-layout>
  ...
  <main class="col-12 col-md-10 px-4 py-4">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="GET" action="{{ route('admin.class-lists') }}" class="row g-3">
          <!-- Grade Level -->
          <div class="col-md-3">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      gradeSelect.addEventListener('change', function() {
        ...
        // Show/hide strand field for Grade 11 and 12
      ...
      function loadStrands(gradeLevel) {
        fetch(`/admin/class-lists/get-strands?grade_level=${gradeLevel}`)
      ...
      function loadTracks() {
        ...
        fetch(`/admin/class-lists/get-tracks?grade_level=${gradeLevel}&strand=${strand}`)
          .then(response => response.json())
          .then(data => {
            if (data.success) {
      ...
      function loadSections() {
        ...
        let url = `/admin/class-lists/get-sections?grade_level=${gradeLevel}`;
        if (strand) url += `&strand=${strand}`;
