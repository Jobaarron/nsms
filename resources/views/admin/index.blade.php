<x-admin-layout>
  ...
  <script>
    // User Types Pie Chart - Only initialize if element exists
    const userTypesCanvas = document.getElementById('userTypesChart');
    if (userTypesCanvas) {
      const userTypesCtx = userTypesCanvas.getContext('2d');
    ...
    // Enrollment Status Bar Chart - Only initialize if element exists
    const enrollmentStatusCanvas = document.getElementById('enrollmentStatusChart');
    if (enrollmentStatusCanvas) {
      const enrollmentStatusCtx = enrollmentStatusCanvas.getContext('2d');
    ...
    // Monthly Applications Line Chart - Only initialize if element exists
    const monthlyApplicationsCanvas = document.getElementById('monthlyApplicationsChart');
    if (monthlyApplicationsCanvas) {
      const monthlyApplicationsCtx = monthlyApplicationsCanvas.getContext('2d');
    ...
    function refreshDashboardStats() {
      fetch('{{ route("admin.dashboard.stats") }}')
        ...
        .then(data => {
          ...
          if (totalRolesEl) totalRolesEl.textContent = data.total_roles;
