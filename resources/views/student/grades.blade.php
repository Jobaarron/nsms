      ...
      <div class="card-body">
        <div class="row g-3">
          ...
          <div class="col-6 col-lg-3">
            ...
            @else
              <div class="card h-100 opacity-50" data-quarter="{{ $quarter }} Quarter" title="@if(!$hasPaidForQuarter)Payment required for this quarter@else No grades available yet@endif">
                <div class="card-body text-center">
