    ...
    @push('scripts') 
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (enrollmentForm) {
                    enrollmentForm.dataset.totalAmount = '{{ $totalAmount ?? 0 }}';
                    enrollmentForm.dataset.scheduleDate = '{{ now()->addDays(7)->format('Y-m-d') }}';
                }
            });
=======
...
>>>>>>> 858006f1d77c8c84c8d22c2ba4f67c02311dfe5e
        </script>
    @endpush
</x-student-layout>